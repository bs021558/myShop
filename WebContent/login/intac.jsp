...
<div id="ser2"><label for="ser2_1"><span id="t1"></span></label>
</div><br><br>



<div id="ser3"><input type="checkbox" id="ser3_1"><label for="ser3_1">myshop 서비스 약관동의 <span id="t2">(필수)</span></label>
</div> <br><br>
<div id ="ser3_1_1"><%@include file="./pieces_txt/join_txt1.jsp" %></div>
...
<div id="ser6"><label for="ser6_1">※ 선택사항에 동의하지 않으셔도 서비스 가입 및 이용이 가능하나,&nbsp; 동의하지 않을 경우 제공 가능한 관련 편의 사항 등 (주변매장찾기 , 적립금, 기타 각종 혜택 등)이 제한될 수 있습니다.</label>
</div> <br><br><hr style="margin:2% 10%;">
<script type="text/javascript">
function join2(){
	window.location.href='/myShop/login/insertForm.jsp';
}
</script>
