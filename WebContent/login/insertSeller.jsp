...
<%@ include file="/include/top.jsp"%> <!-- 상단 -->
    	...
    	<input type = "hidden" name = "user_cash" value = "3" />
			<table style="width: 40; margin: auto;" border="1" >
				...
				<tr>
					...
					<td colspan="2">
				       <label><a href="insertForm.jsp">&ensp;&ensp;구매자<input type="radio" name="rating" value="2" /></a></label>  
				       <label><a href="insertSeller.jsp">판매자<input type="radio" name="rating" value="1" checked/></a></label> 
				    </td>
				</tr>
				<tr id="Radio_On">
