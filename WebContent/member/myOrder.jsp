...
<%
		...
		orderList = odao.getOrderList(user_id, preMonths, nextMonths, startRow, endRow); 
	}
%>
...
%>
	<tr height="30">
	 ...
	 <td width="250">
	   ...
	   <%=gdto.getGoods_name() %>외 <%=countGoods%>개 상품
	 </td>
	 <td align="center" width="50">
	  <%=odto.getTotal_price()%>원
	 </td>
	 <td align="center" width="100">
	  <%=odto.getOrder_date()%>
	 </td>
