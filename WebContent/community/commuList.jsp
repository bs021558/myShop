...
<body>
 ...
 %> <a
					href="/myShop/login/loginForm.jsp">로그인</a> <%
 	}
 %>
				</td>
		</table>
		...
		<table border="1" width="700" cellpadding="0" cellspacing="0"
			...
			<tr height="30">
				...
				<td align="center" width="250" bgcolor="#D9E5FF"><a
					href="notice.jsp?num=<%=notice.getNoti_num()%>&pageNum=<%=currentPage%>&content=commu">
 ...
 %> <img src="/myShop/dev_img/new.jpg" border="0" height="16">
					<%
						}
					%></td>
				<td align="center" width="100" bgcolor="#D9E5FF">운영자</td>
			...
			<tr height="30">
				...
				<td width="250" align="center"><a
					href="community.jsp?num=<%=cm.getNum()%>&pageNum=<%=currentPage%>">
						<%=cm.getSubject()%></a> <%
 	if (cm.getReadcount() >= 50) {
 %> <img
					src="/myShop/dev_img/hot.gif" border="0" height="16">
					<%
						}
					%></td>
		...
		%>
		<a href="commuList.jsp?pageNum=<%=i%>">[<%=i%>]
		</a>
		<%
			}
				if (endPage < pageCount) {
