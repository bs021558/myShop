...
public class OpBoardDAO {
    ...
    public ArrayList selectInquiry(int start, int end) { //�亯���� ���� ��ȸ
    ...
    public ArrayList userselect(int start, int end) { //ȸ���� �ڽ���ȸ
		ArrayList list = new ArrayList();	
		try {
			conn = DBCon.getConnection();
	...
	public void insertOpBoard(OpBoardDTO dto) { //��� ���� �߰�
		try {
			conn = DBCon.getConnection();
