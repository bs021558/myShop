...
public class QnaDAO {
	...
	public int getQnaCount(int goods_code)
		    throws Exception {
		        Connection conn = null;
		        PreparedStatement pstmt = null;
		        ResultSet rs = null;
	...
	public List getQnas(int start, int end) 
		    throws Exception {
		        Connection conn = null;
		        PreparedStatement pstmt = null;
		        ResultSet rs = null;
	...
	public List getQnas(int start, int end, String writer)
    throws Exception {
        List QnaList=null;
        try {
    ...
    public QnaDTO updateGetQna(int num) 
    throws Exception {
        QnaDTO dto=null;
        try {
        	conn = DBCon.getConnection();
